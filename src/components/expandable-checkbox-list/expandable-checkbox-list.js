function checkboxPress() {
  ...
  const checkboxArrow = document.querySelector(
    ".expandable-checkbox-container__icon"
  );
  if (checkbox) {
    checkbox.addEventListener("click", () => {
      checkboxForm.classList.toggle("expandable-checkbox");
      checkboxArrow.classList.toggle(
        "expandable-checkbox-container__icon--disabled"
      );
    });
  }
}

export { checkboxPress };
