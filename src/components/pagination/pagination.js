...
export function pagination(totalPages, page) {
  if (document.querySelector(".pagination")) {
    ...
    let activePage = document.getElementsByClassName(
    ...
    if (page > 2) {
      previousPageButton.nextElementSibling.addEventListener("click", () =>
        pagination(totalPages, 1)
      );
    }

    if (page < totalPages - 1) {
      nextPageButton.previousElementSibling.addEventListener("click", () =>
    ...
    if (page > 1 && page < totalPages + 1) {
      ...
      nextPageButton.previousElementSibling.previousElementSibling.previousElementSibling.addEventListener(
        "click",
        () => pagination(totalPages, page + 1)
      );
    }
    ...
    if (page == 1) {
      ...
      nextPage.nextElementSibling.addEventListener("click", () =>
      ...
      previousPage.previousElementSibling.addEventListener("click", () =>
        pagination(totalPages, page - 2)
      );
    }
  }
